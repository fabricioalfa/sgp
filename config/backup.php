...
return [
    ...
    'backup' => [
        ...
        'source' => [
             ...
             * Do NOT include dump_command_path here; that goes in config/database.php.
             */
            'databases' => [
         ...
         *
         * You can also create a custom compressor. More info on that here:
         ...
         * The file extension should be specified without a leading dot.
         */
