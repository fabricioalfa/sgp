...
@section('title', 'Registrar Misa')

@section('content')
  <div class="overflow-auto max-h-[80vh] bg-white/60 p-6 rounded-xl shadow-lg">
    <h2 class="text-2xl font-bold text-[#C1440E] mb-4">Registrar nueva misa</h2>
    <form action="{{ route('misas.store') }}" method="POST" class="space-y-5">
      @csrf
      @include('misas.form')
