  ...
  <form method="POST" action="{{ route('sacramentos.store') }}">
    ...
    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
      <div>
        ...
        <select name="tipo_sacramento" x-model="tipoSacramento" class="w-full border rounded-lg px-3 py-2" required>
      ...
      <div>
        ...
        <input type="text" name="apellido_paterno" class="w-full border rounded-lg px-3 py-2" required>
