...
{{-- Campo: Imagen --}}
<div>
  <label class="block text-sm font-semibold text-[#C1440E] mb-1">Imagen (opcional)</label>
  ...
  @if(isset($actividad) && $actividad->imagen)
    <div class="mt-2">
      <img src="{{ asset($actividad->imagen) }}" alt="Imagen actual" class="w-40 rounded-lg shadow">
    </div>
  @endif
</div>
